//! Arguments for Get-DomainSite operations
...
/// Arguments for Get-DomainSite
///
/// Arguments for enumerating Active Directory sites.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct ArgsGetDomainSite {
    /// Site identity
...
impl Default for ArgsGetDomainSite {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[test]
    fn test_args_get_domain_site_new() {
        let args = ArgsGetDomainSite::new();
        assert_eq!(args.gp_link, None);
        assert_eq!(args.result_page_size, 200);
    }

    #[test]
    fn test_args_get_domain_site_builder() {
        let args = ArgsGetDomainSite::new()
