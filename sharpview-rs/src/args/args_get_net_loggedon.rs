//! Arguments for Get-NetLoggedon operations

use crate::args::NetworkCredential;
use serde::{Deserialize, Serialize};

/// Arguments for Get-NetLoggedon
///
/// Arguments for enumerating logged-on users via NetWkstaUserEnum.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct ArgsGetNetLoggedon {
...
impl Default for ArgsGetNetLoggedon {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[test]
    fn test_args_get_net_loggedon_new() {
        let args = ArgsGetNetLoggedon::new();
        assert_eq!(args.computer_name, vec!["localhost".to_string()]);
    }

    #[test]
    fn test_args_get_net_loggedon_builder() {
        let args = ArgsGetNetLoggedon::new()
