//! Arguments for Get-WMIProcess operations

use crate::args::NetworkCredential;
use serde::{Deserialize, Serialize};

/// Arguments for Get-WMIProcess
///
/// Arguments for enumerating processes via WMI.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct ArgsGetWmiProcess {
...
impl Default for ArgsGetWmiProcess {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[test]
    fn test_args_get_wmi_process_new() {
        let args = ArgsGetWmiProcess::new();
        assert_eq!(args.computer_name, vec!["localhost".to_string()]);
    }

    #[test]
    fn test_args_get_wmi_process_builder() {
        let args = ArgsGetWmiProcess::new()
