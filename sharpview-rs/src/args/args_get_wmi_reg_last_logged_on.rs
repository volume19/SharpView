//! Arguments for Get-WMIRegLastLoggedOn operations

use crate::args::NetworkCredential;
use serde::{Deserialize, Serialize};

/// Arguments for Get-WMIRegLastLoggedOn
///
/// Gets last logged-on user via WMI registry.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct ArgsGetWmiRegLastLoggedOn {
...
impl ArgsGetWmiRegLastLoggedOn {
    pub fn new() -> Self {
        Self {
...
impl Default for ArgsGetWmiRegLastLoggedOn {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[test]
    fn test_args_get_wmi_reg_last_logged_on_new() {
        let args = ArgsGetWmiRegLastLoggedOn::new();
        assert_eq!(args.computer_name, vec!["localhost".to_string()]);
    }

    #[test]
    fn test_args_get_wmi_reg_last_logged_on_builder() {
        let args = ArgsGetWmiRegLastLoggedOn::new()
